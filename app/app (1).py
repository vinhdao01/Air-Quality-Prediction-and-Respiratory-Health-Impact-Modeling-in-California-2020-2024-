...
# -----------------------------------
# Air Quality vs Health — FIX: removed broken trendline
# -----------------------------------
    ...
    if joint is None:
        ...
        # FIX: removed transform_regression trendline that caused TypeError
        # scatter plot only — correlation metric below still shows the trend
        chart = alt.Chart(df_plot).mark_circle(size=90).encode(
